//
//  VLXOrderDetailModel.h
//  Vlvxing
//
//  Created by 王静雨 on 2017/6/19.
//  Copyright © 2017年 王静雨. All rights reserved.
//

#import "JSONModel.h"
@class VLXOrderDetailDataModel;
@interface VLXOrderDetailModel : JSONModel
@property (nonatomic, copy) NSString *message;
@property (nonatomic, strong) NSNumber *status;
@property (nonatomic,strong)VLXOrderDetailDataModel *data;
@end
@interface VLXOrderDetailDataModel : JSONModel
