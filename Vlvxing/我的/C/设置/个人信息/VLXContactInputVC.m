...
@interface VLXContactInputVC ()<UITextFieldDelegate>
@property(nonatomic,strong)UITextField  * textfield;
@end

@implementation VLXContactInputVC
...
-(void)createUI
{
    ...
    self.textfield.placeholder=[NSString stringWithFormat:@"请输入%@",_titleStr];
...
- (void)setNav{
    self.title = [ZYYCustomTool checkNullWithNSString:_titleStr];
