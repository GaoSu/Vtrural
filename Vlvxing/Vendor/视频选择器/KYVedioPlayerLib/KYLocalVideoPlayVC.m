...
//    playerFrame = CGRectMake(0, 20, kScreenWidth, (kScreenWidth)*(0.75));
...
//    [[UIApplication sharedApplication] setStatusBarHidden:YES withAnimation:UIStatusBarAnimationSlide];
    ...
    playerFrame=CGRectMake(0, 0, kScreenWidth, kScreenHeight);
    //
...
//-(void)getVideoSize//获取视频尺寸
//{
//    AVAsset *asset = [AVAsset assetWithURL:[NSURL fileURLWithPath:_URLString]];
//    self.asset = asset;
