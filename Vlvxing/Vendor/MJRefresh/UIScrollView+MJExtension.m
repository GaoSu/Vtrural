...
- (void)setMj_insetT:(CGFloat)mj_insetT
{
    ...
    inset.top = mj_insetT;
    //grm参照http://blog.csdn.net/zyzxrj/article/details/78116183
    
    NSString* phoneVersion = [[UIDevice currentDevice] systemVersion];
    //
    //    NSLog(@"手机系统版本:%@",phoneVersion);
    //    NSLog(@"%f",[phoneVersion floatValue]);
    float phoneVersionValue = [phoneVersion floatValue];
    if (phoneVersionValue>11.0 || phoneVersionValue==11.0) {
        //        NSLog(@"手机系统版本11或者以上-----------------");
