...
//        [[SDWebImageManager sharedManager] downloadImageWithURL:photo.url options:SDWebImageLowPriority progress:^(NSInteger receivedSize, NSInteger expectedSize) {
////            NSLog(@"%u %lld");
//        } completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, BOOL finished, NSURL *imageURL) {
////            NSLog(@"成功了");
//        }];

        [[SDWebImageManager sharedManager]loadImageWithURL:photo.url options:SDWebImageLowPriority progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
            //            NSLog(@"%u %lld");
...
//         [[SDWebImageManager sharedManager]  downloadImageWithURL:photo.url options:SDWebImageLowPriority progress:nil completed:nil];
    }
}
