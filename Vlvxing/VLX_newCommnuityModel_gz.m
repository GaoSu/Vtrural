...
//
//  VLX_newCommnuityModel_gz.m
//  Vlvxing
//
//  Created by grm on 2018/2/7.
//  Copyright © 2018年 王静雨. All rights reserved.
//

#import "VLX_newCommnuityModel_gz.h"

@implementation VLX_newCommnuityModel_gz
...
-(CGFloat)CellHeight_gz{
    if (_CellHeight_gz) return _CellHeight_gz;

    //    NSLog(@"BBBBBBBBBBBBBB%@",_content);
