...
-(void)FillWithModel:(VLX_fansModel *)model{
    [_headImgvw2 sd_setImageWithURL:[NSURL URLWithString:model.followWhoMember[@"userpic"] ? model.followWhoMember[@"userpic"] : @""] placeholderImage:nil];
