...
@interface VLXDomesticSpotVC ()<UITableViewDelegate,UITableViewDataSource,TitleButtonNoDataViewDelegate>
{
...
@implementation VLXDomesticSpotVC
...
{
    __block VLXDomesticSpotVC *blockSelf=self;
