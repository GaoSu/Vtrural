...
@interface VLXWeekendTripVC ()<UITableViewDelegate,UITableViewDataSource,TitleButtonNoDataViewDelegate>
{
...
@implementation VLXWeekendTripVC
...
{
    __block VLXWeekendTripVC *blockSelf=self;
