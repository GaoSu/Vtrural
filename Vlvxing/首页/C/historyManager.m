...
+(void)SearchText :(NSString *)seaTxt
{
    ...
    //读取数组NSArray类型的数据
    NSArray *myArray = [userDefaultes arrayForKey:@"myArray_lishijilu"];
    ...
    [userDefaultes setObject:searTXT forKey:@"myArray_lishijilu"];
    [userDefaultes synchronize];
}
+(void)removeAllArray{
    
    NSUserDefaults* userDefaults = [NSUserDefaults standardUserDefaults];
    [userDefaults removeObjectForKey:@"myArray_lishijilu"];
