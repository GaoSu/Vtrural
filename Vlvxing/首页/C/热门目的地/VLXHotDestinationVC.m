...
@interface VLXHotDestinationVC ()<UITableViewDelegate,UITableViewDataSource,TitleButtonNoDataViewDelegate>
...
@implementation VLXHotDestinationVC
...
-(void)getNearProductData:(int)type//点击附近时获取商品列表  或者   附近中的自驾游和周末游
{
    ...
    dic[@"areaId"]=[ZYYCustomTool checkNullWithNSString:_areaID];//地区id ， (当查更多时传 -1)
    //
    dic[@"isForeign"]=[ZYYCustomTool checkNullWithNSString:_isForeign];//1国内，2国外
    dic[@"isFeature"]=@"0";//0不是特色，1是
    dic[@"isSpecialPrice"]=@"0";//0不是特价，1是
    dic[@"isGroup"]=@"0";//0不是跟团，1是
    dic[@"isOrder"]=@"0";//0不排序，1排序
