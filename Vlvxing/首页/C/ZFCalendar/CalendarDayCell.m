...
- (void)initView{
    ...
    //选中时显示的图片
//    imgview = [[UIImageView alloc]initWithFrame:CGRectMake(5, 10, self.bounds.size.width-10, self.bounds.size.width-10)];
    imgview = [[UIImageView alloc]initWithFrame:CGRectMake(5, 12, 375/7- 10, 375/7- 10)];

    imgview.image = [UIImage imageNamed:@"chack2.png"];
    [self addSubview:imgview];
    
    //日期
    day_lab = [[UILabel alloc]initWithFrame:CGRectMake(0, 10, self.bounds.size.width, self.bounds.size.width-10)];
    ...
    day_title.textColor = rgba(200, 200, 200, 1);//[UIColor lightGrayColor];
