...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 10.0f, ScreenWidth-20, 17.f)];
...
//    self.masterLabel.textColor = COLOR_THEME;//
    self.masterLabel.textColor = [UIColor grayColor];
    ...
    [dayOfTheWeekLabel setBackgroundColor:[UIColor yellowColor]];
...
//    [self addSubview:self.day1OfTheWeekLabel];
    ...
    [dayOfTheWeekLabel setBackgroundColor:[UIColor blueColor]];
    [dayOfTheWeekLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:15.0f]];
