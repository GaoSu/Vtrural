...
#import "JSONModel.h"
@protocol VLXHomeRecommandDataModel
@end
@interface VLXHomeRecommandModel : JSONModel
@property (nonatomic, copy) NSString *message;
@property (nonatomic, strong) NSNumber *status;
@property (nonatomic,strong)NSArray<VLXHomeRecommandDataModel> *data;
@end

@interface VLXHomeRecommandDataModel : JSONModel
